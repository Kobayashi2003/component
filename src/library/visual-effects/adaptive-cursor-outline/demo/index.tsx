...
import { AdaptiveCursorOutline } from '..'
...
export default function AdaptiveCursorOutlineShowcase() {
  ...
  return (
    <section className="cursor-showcase" style={{ '--cursor-color': color } as CSSProperties}>
      ...
      >
        <div className="shape-field">
          ...
          <div className="shape-set">
            ...
            <button className="shape-pill" type="button" aria-label="Pill shape" />
            <button className="shape-round" type="button" aria-label="Rounded square" />
            <button

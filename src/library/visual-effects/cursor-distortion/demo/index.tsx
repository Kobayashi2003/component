...
import { CursorDistortion } from '..'
import type { CursorDistortionSource } from '..'
...
export default function CursorDistortionShowcase() {
  ...
  const drawSource = useCallback(({ context, width, height }: CursorDistortionSource) => {
    ...
    context.fillText('OPTICAL INTERFACE / MOVE THE LENS', width * 0.43, height * 0.61)
  ...
  return (
    <section className="distortion-showcase">
      <CursorDistortion
      ...
      >
        <span className="distortion-hint">WebGL unavailable — static preview</span>
      </CursorDistortion>
      <aside className="distortion-controls" aria-label="Cursor distortion parameters">
        <p className="distortion-controls__note">Lens affects the canvas artwork only.</p>
        <label>

...
import { CursorSpotlight } from '..'

const lightColors = ['#dbeeff', '#ffd9ad', '#d9c7ff']

export default function CursorSpotlightShowcase() {
  ...
  return (
    <section className="cursor-showcase" style={{ '--spotlight-color': color } as CSSProperties}>
      <CursorSpotlight
      ...
      >
        <div className="spotlight-surface">
          ...
          <div className="material-slab" data-spotlight-shadow>
      ...
      <aside className="spotlight-controls" aria-label="Spotlight parameters">
        ...
        <label>
          ...
          <input
            ...
            onChange={(event) => setShadowDistance(Number(event.target.value))}
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            max="35"
            value={smoothing * 100}
            onChange={(event) => setSmoothing(Number(event.target.value) / 100)}
          />
        </label>

...
import { CursorGravityField } from '..'

const labels = ['Alpha', 'Layout', 'Motion', 'Type', 'System', 'Input', 'Canvas', 'React']

export default function CursorGravityFieldShowcase() {
  ...
  return (
    <section className="cursor-showcase">
      <CursorGravityField
      ...
      <aside className="gravity-controls" aria-label="Gravity field parameters">
        <label>
        ...
        <label>
          ...
          <input
            ...
            onChange={(event) => setMaxDisplacement(Number(event.target.value))}
          />
        </label>
        <label>

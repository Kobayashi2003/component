...
const suites = {
  unit: [
    ...
    "tests/unit/reader-input.test.js",
    ...
    "tests/unit/reader-ui-contract.test.js",
    "tests/unit/reader-ui-configuration.test.js",
    "tests/unit/reader-tool-registry.test.js",
    "tests/unit/reader-surface-renderer-registry.test.js",
    "tests/unit/reader-settings-model.test.js",
    "tests/unit/reading-session-codec.test.js",
...
if (requestedSuite !== "all" && !(requestedSuite in suites)) {
  console.error(
    `Unknown test suite: ${requestedSuite}. Use unit, integration, or all.`,
  );
  process.exit(2);
}

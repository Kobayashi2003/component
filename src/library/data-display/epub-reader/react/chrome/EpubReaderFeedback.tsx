...
export function EpubReaderFeedback({ feedback, feedbackId }: { readonly feedback: ReaderFeedbackSpec; readonly feedbackId: number }) {
  return (
    <div
...
function FeedbackIcon({ tone }: { readonly tone: ReaderFeedbackSpec['tone'] }) {
  const path = tone === 'success' ? 'm7 12 3.1 3.1L17.5 7.7' : 'M8 7v10M12 8.5 16 12l-4 3.5';

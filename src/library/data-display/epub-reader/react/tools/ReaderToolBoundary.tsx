...
export function ReaderToolContent({ tool, context }: { readonly tool: ReaderToolModule; readonly context: ReaderToolContext }) {
...
export function ReaderToolModuleIcon({ tool }: { readonly tool: ReaderToolModule }) {
  return (
    <ReaderContributionBoundary resetKey={tool} fallback={<span className="epub-reader-tool-icon" aria-hidden="true">•</span>}>

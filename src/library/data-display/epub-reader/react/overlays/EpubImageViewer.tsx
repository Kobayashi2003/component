...
export function EpubImageViewerContent({ activation, onClose }: EpubImageViewerProps) {
  ...
  return (
    <>
      <header onClick={(event: MouseEvent<HTMLElement>) => event.stopPropagation()}>
        ...
        <button type="button" aria-label="Close image viewer" onClick={() => onClose(true)}>×</button>
      </header>
